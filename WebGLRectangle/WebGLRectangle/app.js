...
window.onload = function() {
    ...
    let currentColor = [255/255, 215/255, 0/255, 1.0];
    ...
    function changecolor(r, g, b, a){
        currentColor = [r/255, g/255, b/255, a];
        gl.uniform4fv(uColorLocation, currentColor);
        gl.clear(gl.COLOR_BUFFER_BIT);
        gl.drawArrays(gl.TRIANGLE_STRIP, 0, 4);
    }
    ...
    document.getElementById('Color1').onclick = function(){
        changecolor(0,128, 128, 1.0); //teal
    }

    document.getElementById('Color2').onclick = function(){
        changecolor(255, 0, 144, 1.0); //magenta
    }

    document.getElementById('Color3').onclick = function(){
        changecolor(255, 253, 208, 1.0); //cream
    }

    document.getElementById('Reset').onclick = function(){
        changecolor(255, 215, 0, 1.0); //reset
    }
}
